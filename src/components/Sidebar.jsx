...
// Status: Ditambahkan menu "Koleksi Web" baru
    ...
    <div className="w-64 min-h-screen bg-gray-800 text-white p-4 flex flex-col">
      ...
      <nav className="flex-1">
        <ul className="space-y-1">
          <li><NavLink to="/dashboard" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><NoteIcon /><span>Catatan</span></NavLink></li>
          <li><NavLink to="/playground" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><AssetIcon /><span>Koleksi Aset</span></NavLink></li>
          <li><NavLink to="/generators" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><GeneratorIcon /><span>Koleksi Generator</span></NavLink></li>
          <li className="pt-2"><div className="border-t border-gray-700"></div></li>
          <li><NavLink to="/email-manager" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><EmailIcon /><span>Manajer Email</span></NavLink></li>
          <li><NavLink to="/image-reader" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><ScanIcon /><span>Ekstraktor Teks</span></NavLink></li>
          {/* --- MENU KOLEKSI WEB BARU --- */}
          <li><NavLink to="/web-collection" className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><WebIcon /><span>Koleksi Web</span></NavLink></li>
        </ul>
      </nav>
