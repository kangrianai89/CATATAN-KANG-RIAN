    ...
    <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-gray-800 text-white p-4 flex flex-col transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out md:relative md:translate-x-0`}>
      ...
      <nav className="flex-1">
        <ul className="space-y-1">
          ...
          {/* === LINK ASISTEN AI DIHAPUS DARI SINI === */}
          ...
          <li><NavLink to="/account-manager" onClick={handleLinkClick} className={({ isActive }) => `${linkClass} ${isActive ? activeLinkClass : ''}`}><AccountIcon /><span>Manajer Akun</span></NavLink></li>
          ...
          {/* === LINK ASISTEN AI DIPINDAHKAN KE SINI === */}
